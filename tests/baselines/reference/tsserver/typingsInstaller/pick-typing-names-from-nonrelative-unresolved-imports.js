...
Info seq  [hh:mm:ss:mss] New unresolvedImports for /a/b/app.js:: ["foo","foo","foo","@bar/router","@bar/common","@bar/common"]
Info seq  [hh:mm:ss:mss] Calculating unresolved imports list of program:: Files:: 1 Done: ["@bar/common","@bar/router","foo"]
