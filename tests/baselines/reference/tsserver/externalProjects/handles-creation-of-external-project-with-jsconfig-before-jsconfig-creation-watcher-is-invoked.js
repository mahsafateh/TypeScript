...
Info seq  [hh:mm:ss:mss] request:
    {
      ...
      "arguments": {
        "projects": [
          {
            "projectFileName": "/user/username/projects/myproject/WebApplication36.csproj",
            "rootFiles": [
              {
...
Info seq  [hh:mm:ss:mss] event:
    {
      ...
      "body": {
        ...
        "reason": "Creating configured project in external project: /user/username/projects/myproject/WebApplication36.csproj"
      }
    }
...
Info seq  [hh:mm:ss:mss] DirectoryWatcher:: Triggered with /user/username/projects/myproject/javascript.js :: WatchInfo: /user/username/projects/myproject 1 undefined Config: /user/username/projects/myproject/tsconfig.json WatchType: Wild card directory
Info seq  [hh:mm:ss:mss] Project: /user/username/projects/myproject/tsconfig.json Detected file add/remove of non supported extension: /user/username/projects/myproject/javascript.js
Info seq  [hh:mm:ss:mss] Elapsed:: *ms DirectoryWatcher:: Triggered with /user/username/projects/myproject/javascript.js :: WatchInfo: /user/username/projects/myproject 1 undefined Config: /user/username/projects/myproject/tsconfig.json WatchType: Wild card directory
Before request
        ...
        "projects": [
          {
            ...
            "rootFiles": [
              ...
              {
                "fileName": "/user/username/projects/myproject/javascript.js"
              }
            ],
            "options": {
              "allowJs": false
...
Info seq  [hh:mm:ss:mss] event:
    {
      ...
      "body": {
        "triggerFile": "/user/username/projects/myproject/javascript.js",
...
Info seq  [hh:mm:ss:mss] New unresolvedImports for /user/username/projects/myproject/javascript.js:: []
...
Info seq  [hh:mm:ss:mss] 	FileName: /user/username/projects/myproject/javascript.js ProjectRootPath: undefined
        ...
        "projects": [
          {
            ...
            "rootFiles": [
              {
                "fileName": "/user/username/projects/myproject/jsconfig.json"
              },
              {
                "fileName": "/user/username/projects/myproject/tsconfig.json"
              },
...
Info seq  [hh:mm:ss:mss] Creating configuration project /user/username/projects/myproject/jsconfig.json
Info seq  [hh:mm:ss:mss] event:
    {
      "seq": 0,
      "type": "event",
      "event": "projectLoadingStart",
      "body": {
        "projectName": "/user/username/projects/myproject/jsconfig.json",
        "reason": "Creating configured project in external project: /user/username/projects/myproject/WebApplication36.csproj"
      }
    }
Info seq  [hh:mm:ss:mss] Config: /user/username/projects/myproject/jsconfig.json : {
 "rootNames": [
  "/user/username/projects/myproject/javascript.js"
 ],
 "options": {
...
Info seq  [hh:mm:ss:mss] DirectoryWatcher:: Added:: WatchInfo: /user/username/projects/node_modules/@types 1 undefined Project: /user/username/projects/myproject/jsconfig.json WatchType: Type roots
Info seq  [hh:mm:ss:mss] Elapsed:: *ms DirectoryWatcher:: Added:: WatchInfo: /user/username/projects/node_modules/@types 1 undefined Project: /user/username/projects/myproject/jsconfig.json WatchType: Type roots
Info seq  [hh:mm:ss:mss] Finishing updateGraphWorker: Project: /user/username/projects/myproject/jsconfig.json Version: 1 structureChanged: true structureIsReused:: Not Elapsed:: *ms
Info seq  [hh:mm:ss:mss] Project '/user/username/projects/myproject/jsconfig.json' (Configured)
Info seq  [hh:mm:ss:mss] 	Files (2)
	/a/lib/lib.d.ts Text-1 "/// <reference no-default-lib=\"true\"/>\ninterface Boolean {}\ninterface Function {}\ninterface CallableFunction {}\ninterface NewableFunction {}\ninterface IArguments {}\ninterface Number { toExponential: any; }\ninterface Object {}\ninterface RegExp {}\ninterface String { charAt: any; }\ninterface Array<T> { length: number; [n: number]: T; }"
	/user/username/projects/myproject/javascript.js SVC-1-0 ""
...
Info seq  [hh:mm:ss:mss] DirectoryWatcher:: Added:: WatchInfo: /user/username/projects/myproject/bower_components 1 undefined Project: /user/username/projects/myproject/jsconfig.json WatchType: Directory location for typing installer
Info seq  [hh:mm:ss:mss] Elapsed:: *ms DirectoryWatcher:: Added:: WatchInfo: /user/username/projects/myproject/bower_components 1 undefined Project: /user/username/projects/myproject/jsconfig.json WatchType: Directory location for typing installer
Info seq  [hh:mm:ss:mss] DirectoryWatcher:: Added:: WatchInfo: /user/username/projects/myproject/node_modules 1 undefined Project: /user/username/projects/myproject/jsconfig.json WatchType: Directory location for typing installer
Info seq  [hh:mm:ss:mss] Elapsed:: *ms DirectoryWatcher:: Added:: WatchInfo: /user/username/projects/myproject/node_modules 1 undefined Project: /user/username/projects/myproject/jsconfig.json WatchType: Directory location for typing installer
TI:: [hh:mm:ss:mss] Sending response:
    {
      "projectName": "/user/username/projects/myproject/jsconfig.json",
      "typeAcquisition": {
...
Info seq  [hh:mm:ss:mss] event:
    {
      ...
      "body": {
        "telemetryEventName": "projectInfo",
        "payload": {
          "projectId": "1dfbffd3fb9f0e3c8a821e8190198aa3b60c479504a5d4ada55df796a0309cb8",
          "fileStats": {
            "js": 1,
            "jsSize": 0,
            "jsx": 0,
