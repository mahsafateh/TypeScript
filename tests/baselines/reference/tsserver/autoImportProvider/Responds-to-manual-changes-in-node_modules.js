...
Info seq  [hh:mm:ss:mss] 		Projects: /dev/null/inferredProject1*,/dev/null/autoImportProviderProject1*
Info seq  [hh:mm:ss:mss] response:
    {
      "responseRequired": false
    }
        ...
        "openFiles": [
          {
            ...
            "content": "export class ValidatorPattern {}"
          }
        ]
      },
      "seq": 3,
...
Info seq  [hh:mm:ss:mss] Project '/dev/null/inferredProject1*' (Inferred)
Info seq  [hh:mm:ss:mss] 	Files (1)
	/node_modules/@angular/forms/forms.d.ts SVC-2-0 "export class ValidatorPattern {}"
